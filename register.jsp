    ...
    <body>
        <div class="main">
          ...
          <form class="form1">
            ...
            <input class="un" type="password" align="center" placeholder="Password">
            <input class="pass" type="password" align="center" placeholder="Repeat Password">
            <input class="ref" type="text" align="center" placeholder="Phone Number (Optional)">
            <input class="ref" type="text" align="center" placeholder="Refeeral Code (Optional)">
