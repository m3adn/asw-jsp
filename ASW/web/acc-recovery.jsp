...
<html>
    <head>
        ...
        <link rel='stylesheet' type='text/css' media='screen' href='./css/style-acc-recovery.css'> 
    ...
    <body>
        <div class="main">
          ...
          <form name="Forget" method="post" action="Servlet/Login/Forget" class="form1">
              <input class="em" type="text" align="center" name="Email" placeholder="Email">
              <input class="ref" type="text" align="center" name="PhoneNumber" placeholder="Phone Number">
